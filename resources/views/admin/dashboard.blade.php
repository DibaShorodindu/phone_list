        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 d-flex align-items-center justify-content-start">
                    ...
                    <div div class="col-md-2 d-flex align-items-center justify-content-start">
                        <form action="{{ route('file.convert') }}" class="d-flex" >
                            @csrf
                            <input type='submit' class="btn btn-upload" value='Refresh' />
                        </form>
                    </div>
                </div>
            </div>
