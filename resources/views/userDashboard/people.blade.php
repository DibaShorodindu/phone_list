                        ...
                        <ul class="pagination justify-content-end">
                            <li class="page-item">
                                <div class="d-sm-inline-flex justify-content-center">
                                    @if(isset($full_name) != null && isset($location) == null && isset($hometown) == null
                                        && isset($countries) == null && isset($gender) == null && isset($relationship_status) == null)
                                        {!! $allData->appends(['full_name' => $full_name])->links() !!}

                                    @elseif(isset($full_name) == null && isset($location) != null && isset($hometown) == null
                                        && isset($countries) == null && isset($gender) == null && isset($relationship_status) == null)
                                    ...
                                    @elseif(isset($full_name) != null && isset($location) != null && isset($hometown) == null
                                        && isset($countries) == null && isset($gender) == null && isset($relationship_status) == null)
                                        {!! $allData->appends([ 'full_name' => $full_name, 'location' => $location])->links() !!}

                                    @elseif(isset($full_name) != null && isset($location) == null && isset($hometown) != null
                                        && isset($countries) == null && isset($gender) == null && isset($relationship_status) == null)
                                        {!! $allData->appends([ 'full_name' => $full_name, 'hometown' => $hometown])->links() !!}

                                    @elseif(isset($full_name) != null && isset($location) == null && isset($hometown) == null
                                        && isset($countries) != null && isset($gender) == null && isset($relationship_status) == null)
                                        {!! $allData->appends([ 'full_name' => $full_name, 'country' => $countries])->links() !!}

                                    @elseif(isset($full_name) != null && isset($location) == null && isset($hometown) == null
                                        && isset($countries) == null && isset($gender) != null && isset($relationship_status) == null)
                                        {!! $allData->appends([ 'full_name' => $full_name, 'gender' => $gender])->links() !!}

                                    @elseif(isset($full_name) != null && isset($location) == null && isset($hometown) == null
                                        && isset($countries) == null && isset($gender) == null && isset($relationship_status) != null)
                                        {!! $allData->appends([ 'full_name' => $full_name, 'relationship_status' => $relationship_status])->links() !!}
                                    ...
                                    @elseif(isset($full_name) != null && isset($location) != null && isset($hometown) != null
                                        && isset($countries) == null && isset($gender) == null && isset($relationship_status) == null)
                                        {!! $allData->appends(['full_name' => $full_name, 'location' => $location, 'hometown' => $hometown])->links() !!}

                                    @elseif(isset($full_name) != null && isset($location) != null && isset($hometown) == null
                                         && isset($countries) != null && isset($gender) == null && isset($relationship_status) == null)
                                        {!! $allData->appends(['full_name' => $full_name, 'location' => $location, 'country' => $countries])->links() !!}

                                    @elseif(isset($full_name) != null && isset($location) != null && isset($hometown) == null
                                         && isset($countries) == null && isset($gender) != null && isset($relationship_status) == null)
                                        {!! $allData->appends(['full_name' => $full_name, 'location' => $location, 'gender' => $gender])->links() !!}

                                    @elseif(isset($full_name) != null && isset($location) != null && isset($hometown) == null
                                         && isset($countries) == null && isset($gender) == null && isset($relationship_status) != null)
                                        {!! $allData->appends(['full_name' => $full_name, 'location' => $location, 'relationship_status' => $relationship_status])->links() !!}

                                    @elseif(isset($full_name) != null && isset($location) == null && isset($hometown) != null
                                        && isset($countries) != null && isset($gender) == null && isset($relationship_status) == null)
                                        {!! $allData->appends(['full_name' => $full_name, 'hometown' => $hometown, 'country' => $countries])->links() !!}

                                    @elseif(isset($full_name) != null && isset($location) == null && isset($hometown) != null
                                        && isset($countries) == null && isset($gender) != null && isset($relationship_status) == null)
                                        {!! $allData->appends(['full_name' => $full_name, 'hometown' => $hometown, 'gender' => $gender])->links() !!}

                                    @elseif(isset($full_name) != null && isset($location) == null && isset($hometown) != null
                                        && isset($countries) == null && isset($gender) == null && isset($relationship_status) != null)
                                        {!! $allData->appends(['full_name' => $full_name, 'hometown' => $hometown, 'relationship_status' => $relationship_status])->links() !!}

                                    @elseif(isset($full_name) != null && isset($location) == null && isset($hometown) == null
                                        && isset($countries) != null && isset($gender) != null && isset($relationship_status) == null)
                                        {!! $allData->appends(['full_name' => $full_name, 'country' => $countries, 'gender' => $gender])->links() !!}

                                    @elseif(isset($full_name) != null && isset($location) == null && isset($hometown) == null
                                        && isset($countries) != null && isset($gender) == null && isset($relationship_status) != null)
                                        {!! $allData->appends(['full_name' => $full_name, 'country' => $countries, 'relationship_status' => $relationship_status])->links() !!}

                                    @elseif(isset($full_name) != null && isset($location) == null && isset($hometown) == null
                                        && isset($countries) == null && isset($gender) != null && isset($relationship_status) != null)
                                        {!! $allData->appends(['full_name' => $full_name, 'gender' => $gender, 'relationship_status' => $relationship_status])->links() !!}
                                    ...
                                    @elseif(isset($full_name) != null && isset($location) != null && isset($hometown) != null
                                    && isset($countries) != null && isset($gender) == null && isset($relationship_status) == null)
                                        {!! $allData->appends([ 'full_name' => $full_name, 'location' => $location, 'hometown' => $hometown,
                                    ...
                                    @elseif(isset($full_name) != null && isset($location) != null && isset($hometown) == null
                                        && isset($countries) != null && isset($gender) != null && isset($relationship_status) == null)
                                        {!! $allData->appends([ 'full_name' => $full_name, 'location' => $location,
                                    ...
                                    @elseif(isset($full_name) != null && isset($location) == null && isset($hometown) != null
                                        && isset($countries) != null && isset($gender) != null && isset($relationship_status) == null)
                                        {!! $allData->appends([ 'full_name' => $full_name, 'hometown' => $hometown,
                                            'country' => $countries, 'gender' => $gender])->links() !!}
                                    ...
                                    @elseif(isset($full_name) != null && isset($location) == null && isset($hometown) == null
                                        && isset($countries) != null && isset($gender) != null && isset($relationship_status) != null)
                                        {!! $allData->appends([ 'full_name' => $full_name,
